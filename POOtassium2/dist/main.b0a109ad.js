...
function (_super) {
  ...
  PlayScene.prototype.create = function () {
    ...
    this.enemy = enemy.get(300, 20, 'enemy').setCircle(10).setOffset(6);
    this.scan = this.physics.add.sprite(this.enemy.x - 110, this.enemy.y - 110, 'enemy').setVisible(false).setCircle(120).setOffset(6);
    this.enemy2 = enemy.get(100, 300, 'enemy').setCircle(10).setOffset(6);
    ...
    this.Jmove = this.time.addEvent({
      callback: function callback() {
        _this.physics.moveTo(_this.jimmy, 395, 10, 5);
    ...
    this.Jmoveback = this.time.addEvent({
      callback: function callback() {
        _this.physics.moveTo(_this.jimmy, 395, -10, 10);
  ...
  PlayScene.prototype.text = function () {
    var _this = this;

    setTimeout(function () {
      return _this.text1 = _this.add.text(385, 25, "Are they gone?");
    }, 5000);
    setTimeout(function () {
      return _this.text1.destroy();
    }, 8000);
    setTimeout(function () {
      return _this.text2 = _this.add.text(385, 25, "Yes?");
    }, 10000);
    setTimeout(function () {
      return _this.text2.destroy();
    }, 11000);
    setTimeout(function () {
      return _this.text3 = _this.add.text(385, 25, "OH! Thank you so much");
    }, 12000);
    setTimeout(function () {
      return _this.text4 = _this.add.text(385, 40, "for dealing with these");
    }, 12000);
    setTimeout(function () {
      return _this.text5 = _this.add.text(385, 55, "annoying ruffians!");
    }, 12000);
    setTimeout(function () {
    ...
    setTimeout(function () {
      return _this.text6 = _this.add.text(385, 25, "Follow me!");
    }, 17000);
    setTimeout(function () {
    ...
    setTimeout(function () {
      return _this.exit = _this.physics.add.image(395, -15, "jimmy").setVisible(false);
    }, 19000);
  }; //banana
...
function (_super) {
  ...
  banana.prototype.preUpdate = function (time, delta) {
    if (this.scene.physics.overlap(this, this.scene.player)) {
      this.scene.addbanana(), this.destroy();
    }
  };
...
function (_super) {
  ...
  poop.prototype.preUpdate = function (time, delta) {
    ...
    if (this.scene.physics.collide(this, this.scene.enemy)) {
      this.setVisible(false), this.active = false, this.scene.sound.play("splet2"), this.scene.enemy.destroy(), this.scene.enemy2.pause();
      this.scene.drop();
    }
