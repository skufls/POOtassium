   ...
   constructor(){
    ...
    create(){
       ...
       this.Jmoveback= this.time.addEvent({
        callback: ()=>{
            this.physics.moveTo(this.jimmy,  395,-10,10)
            this.jimmy.rotation = Phaser.Math.Angle.Between(this.jimmy.x, this.jimmy.y, this.player.x, this.player.y);  
    ...
    text(){
        ...
        setTimeout(() => this.text1 =  this.add.text(385, 25, "Are they gone?"), 5000);
        setTimeout(() => this.text1.destroy(), 8000);
        setTimeout(() => this.text2 =  this.add.text(385, 25, "Yes?"), 10000);
        setTimeout(() => this.text2.destroy(), 11000);
        setTimeout(() => this.text3 =  this.add.text(385, 25, "OH! Thank you so much"), 12000);
        setTimeout(() => this.text4 =  this.add.text(385, 40, "for dealing with these"), 12000);
        setTimeout(() => this.text5 =  this.add.text(385, 55, "annoying ruffians!"), 12000);
        setTimeout(() => this.text3.destroy(), 16000);
        setTimeout(() => this.text4.destroy(), 16000);
        setTimeout(() => this.text5.destroy(), 16000);
        setTimeout(() => this.text6 =  this.add.text(385, 25, "Follow me!"), 17000);
        setTimeout(() => this.text6.destroy(), 19000);
        setTimeout(()=> this.Jmove.paused = true,19000);
        setTimeout(()=> this.Jmoveback.paused = false,19000);
        setTimeout(()=> this.exit = this.physics.add.image(395,-15, "jimmy")
